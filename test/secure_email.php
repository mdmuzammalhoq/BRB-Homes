...
$send_to1 = "rumon7528@gmail.com";//"adibatex@gmail.com";
$subject ="Express Holidays Enquiry Form ". $_REQUEST[company_name];
 
// Headers
$from = $_REQUEST[email];
$headers = "From: $_REQUEST[email]\n"; // From address
$headers .= "Reply-To: $_REQUEST[email]\n"; // Reply-to address
$headers .= "Organization: www.expressholidaysbd.com\n"; // Organisation
