        ...
        <div class="grid_10">
            <div class="box round first grid">
                ...
                <div class="block">        
					...
					<tbody>
                    <?php 
                        $query = "select * from handovered order by id DESC";
                    ...
                    ?>
						...
						<td ><?php echo $result['id']; ?></td>
							...
							<td style="text-align: center; "><a href="handoveredit.php?editid=<?php echo $result['id']; ?>">Edit</a> || <a href="delhand.php?delid=<?php echo $result['id']; ?>">Delete</a></td>
						</tr>
                    <?php  } } ?>
