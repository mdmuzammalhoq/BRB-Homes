...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if($name == "" || $p_location == "" || $l_area == "" || $b_soried == "" || $units == "" || $total_flat == "" || $total_car_parking == "" || $a_size == "" || $h_date == "" || $file_name == ""){
        ...
        $msg = "<span style='color:red;'>Name field Must not be empty !!</span>";
                ...
                $query = "INSERT INTO brb_upcomming(name, p_location, l_area, b_soried, units, total_flat, total_car_parking, a_size, h_date, image) VALUES('$name', '$p_location', '$l_area', '$b_soried', '$units', '$total_flat', '$total_car_parking', '$a_size', '$h_date', '$uploaded_image')";
